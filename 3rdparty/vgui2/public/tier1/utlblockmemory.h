...
void CUtlBlockMemory<T,I>::Swap( CUtlBlockMemory< T, I > &mem )
{
    ...
    { int _mask = m_nIndexMask; m_nIndexMask = mem.m_nIndexMask; mem.m_nIndexMask = _mask; }
    { int _shift = m_nIndexShift; m_nIndexShift = mem.m_nIndexShift; mem.m_nIndexShift = _shift; }
}
