...
#define POINTER_TO_UINT( p ) ( (unsigned int)(uintp)( p ) )
...
#if defined( __LP64__ ) || defined( __LP64 ) || defined( _WIN64 )
...
inline uint64 QWordSwap( uint64 dw )
{
   uint64 temp;

   temp  =   dw >> 56;
   temp |= ( dw & 0x00FF000000000000ULL ) >> 40;
   temp |= ( dw & 0x0000FF0000000000ULL ) >> 24;
   temp |= ( dw & 0x000000FF00000000ULL ) >> 8;
   temp |= ( dw & 0x00000000FF000000ULL ) << 8;
   temp |= ( dw & 0x0000000000FF0000ULL ) << 24;
   temp |= ( dw & 0x000000000000FF00ULL ) << 40;
   temp |= ( dw & 0x00000000000000FFULL ) << 56;
...
#if defined(__BYTE_ORDER__) && (__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__) && !defined(VALVE_LITTLE_ENDIAN)
#define VALVE_LITTLE_ENDIAN 1
#endif
#if !defined(VALVE_LITTLE_ENDIAN) && (defined(__i386__) || defined(__x86_64__) || defined(__arm__) || defined(__aarch64__))
#define VALVE_LITTLE_ENDIAN 1
#endif
