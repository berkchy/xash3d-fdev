// vgui2_memalloc.cpp - minimal IMemAlloc for the static VGUI2 port.
//
// Valve's tier1 references g_pMemAlloc (e.g. CUtlMemory::GetAllocationSize).
// BugfixedHL links it from prebuilt tier0; here it is backed by the C heap.
